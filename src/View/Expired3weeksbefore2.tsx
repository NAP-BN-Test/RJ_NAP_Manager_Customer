...
function Expired3weeksbefore2() {
  ...
  function getlistcustomer2(searchKey: string, value: number) {
    dispatch(Action.act_get_list_customer_preexpired2(searchKey, value));
  }
  ...
  function getlistcustomerSearch(searchKey: string,) {
    ...
    dispatch(Action.act_get_list_customer_preexpired2(searchKey, 1));
  }
  ...
  return (
    <div className="site-layout-content">
      <Breadcrumb style={{ margin: "16px 0px" }}>
        ...
        <Breadcrumb.Item>Danh sách khách hàng sắp hết hạn</Breadcrumb.Item>
      </Breadcrumb>
...
export default Expired3weeksbefore2;
